...
const question16Data = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        question: "Chọn key theo topic",
        options: [
          "Refusing to seek advice from others",
          "Spending too much time editing each chapter",
    ...
    questions: [
      {
        ...
        options: [
          ...
          "He plans to release one more album",
          "He wants to start performing overseas"
        ]
      },
      {
        id: "17.2",
        ...
        options: [
          ...
          "He could have attracted younger fans",
    ...
    questions: [
      {
        ...
        options: [
          ...
          "It has already become his best-selling novel.",
      ...
      },
      {
        ...
        options: [
          ...
          "He should write more books in the same style.",
          "He should take a break before starting another novel."
        ]
      }
    ],
    transcript: ""
    ...
    questions: [
      {
        ...
        options: [
          ...
          "To complete every task as quickly as possible.",
          "To follow instructions without asking questions."
        ]
      },
      {
        id: "17.2",
        ...
        options: [
          ...
          "It depends entirely on the type of job.",
          "Most companies still use the same definition as before."
        ]
      }
    ],
    transcript: ""
...
/* MINI_HIPPO_LESSON_DATA_START
{
  ...
  "sets": [
    {
      "title": "LISTENING ĐỀ 14 - Question 16 & 17",
      "part": "16_17",
      "question16": {
        "topic": "Writer’s block",
        "audioUrl": "",
    ...
    {
      "title": "LISTENING ĐỀ 13 - Question 16 & 17",
      "part": "16_17",
      "question16": {
        "topic": "A new novel of a famous writer",
        "audioUrl": "",
