...
//----------------------------------------------------------------------
const questions1 = {
    "question1_1": "1. What is your hobby?",
    "question1_2": "2. What is your favorite food?",
    "question1_3": "3. What is your favorite time of a day? ",
    "question1_4": "4. How do you get to work?",
    "question1_5": "5. Where are you from? ",
};
...
//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "\nA: I know there are a lot of successful small businesses these days. Tell me about a successful small business in your area. \n\n\n",
    "question3_2": "\nB: I have a friend who wants to open a second coffee shop. She opened her first one a year ago and it was quite successful. What advice do you have to help her to be more successful in her second shop? \n\n\n\n",
    "question3_3": "\nC: Can you tell me what qualities and skills are needed to create a successful small business? \n",
};
...
//----------------------------------------------------------------------
const questions4_main = "“Dear members, \nOur club is currently planning to support local individuals who want to start up a small business. The club has 2 proposals: First, create a call center where customers can call to ask questions and request help. Second, create free courses to support local universities nearby. Let us know which option you would use and why.” \n";
