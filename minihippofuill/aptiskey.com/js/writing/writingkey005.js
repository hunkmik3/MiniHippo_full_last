...
//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "A: Do you often watch movies on your laptop or go to the theater?\n\n\n\n\n",
    "question3_2": "B: I used to work on a laptop and it stopped and I lost all my notes. Tell me about a bad time with your computer?\n\n\n\n\n",
    "question3_3": "C: Technological improvements have made our lives easier. what do you think?\n\n\n\n\n",
};
...
//----------------------------------------------------------------------
const questions4_main = "“Dear member,\nThere have been some negative comments on the club’s website. The problem is that all of the comments are anonymous. We are considering changing the system and would like to hear your opinion about this. Do you have any other solutions?”\n";
