...
//----------------------------------------------------------------------
const questions1 = {
    "question1_1": "What is your name?",
    "question1_2": "How old are you?",
    "question1_3": "Where do you live?",
    "question1_4": "What is your favorite season?",
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Talk about a foreign language you are learning at school.",
};
...
//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "I used to learn French and I find it is very interesting. Tell me about a memory you had with a foreign language. ",
    "question3_2": "It is easy for me to forget words. Can you give me some tips on how to remember new words?",
    "question3_3": "Some people learn English through videos and reading books. However, there are also many private classes and teachers. What is the most effective way to learn?",
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear members,\nThe club will organize an event in order to attract both young and old audiences. Therefore, our club need a guest speaker and the main theme. Write an email expressing your desire to be a speaker and give the topic of the talk.";
