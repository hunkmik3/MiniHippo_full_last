const key_id = "Bộ đề #222";
const club_name = "jhkkjhk2kjh";
//----------------------------------------------------------------------
const questions1 = {
    "question1_1": "khkjh",
    "question1_2": "kjh",
...
const questions1_answer = {
    "question1_1_answer": "kjh",
    "question1_2_answer": "jhk",
    "question1_3_answer": "jhk",
    "question1_4_answer": "bkhbkj",
    "question1_5_answer": "khkjhhkjhkj",
};
//----------------------------------------------------------------------
const questions2 = {
    "question2": "hbhkbkj",
...
const questions2_answer = {
    "question2": "kjhkjhkjhk",
};
//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "hbhbkhjbkjh",
    "question3_2": "jhkjhkjhkjhk",
    "question3_3": "nmb,mn,m",
};
const questions3_answer = {
    "question3_1_answer": "kjhkjhjk",
    "question3_2_answer": "kjhkjhkjhjklhl",
    "question3_3_answer": "vnb",
};
//----------------------------------------------------------------------
const questions4_main = "cvbvc";
const question4_1_text = "vcbvcWrite a short email to your friend. Tell your friend your feelings about this and what you plan to do.";
const question4_2_text = "vnbvnbvnbnWrite an email to the president of the club. Tell them your thoughts about this and what you would like to do.";
const question4_1_text_answer = `nvnbvbnvnbvnbvn`;
const question4_2_text_answer = `hgiuyhoiupioup`;
