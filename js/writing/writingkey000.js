...
// Cập nhật prompt (Giữ nguyên logic cũ)
...
// ... (Các hàm xử lý submit giữ nguyên, chỉ copy lại logic render) ...
...
// ... (Các logic xử lý show modal đáp án giữ nguyên) ...
