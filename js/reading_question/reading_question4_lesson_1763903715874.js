...
const question4Content_1 = [
    { question: "Who enjoys playing with their children?", id: "question4_q1", options: ["", "A", "B", "C", "D"], answer: "B" },
    { question: "Who enjoys playing with their children?", id: "question4_q2", options: ["", "A", "B", "C", "D"], answer: "C" },
    { question: "Who enjoys playing with their children?", id: "question4_q3", options: ["", "A", "B", "C", "D"], answer: "D" },
    { question: "Who enjoys playing with their children?", id: "question4_q4", options: ["", "A", "B", "C", "D"], answer: "B" },
    { question: "Who enjoys playing with their children?", id: "question4_q5", options: ["", "A", "B", "C", "D"], answer: "C" },
    { question: "Who enjoys playing with their children?", id: "question4_q6", options: ["", "A", "B", "C", "D"], answer: "C" },
    { question: "Who enjoys playing with their children?", id: "question4_q7", options: ["", "A", "B", "C", "D"], answer: "B" },
];

const correctAnswersQuestion4_1 = ['B', 'C', 'D', 'B', 'C', 'C', 'B'];
...
const question4Content_2 = [
    { question: "Who enjoyed playing with friends in childhood?", id: "question4_q1", options: ["", "A", "B", "C", "D"], answer: "A" },
    { question: "Who enjoyed playing with friends in childhood?", id: "question4_q2", options: ["", "A", "B", "C", "D"], answer: "D" },
    { question: "Who enjoyed playing with friends in childhood?", id: "question4_q3", options: ["", "A", "B", "C", "D"], answer: "B" },
    { question: "Who enjoyed playing with friends in childhood?", id: "question4_q4", options: ["", "A", "B", "C", "D"], answer: "C" },
    { question: "Who enjoyed playing with friends in childhood?", id: "question4_q5", options: ["", "A", "B", "C", "D"], answer: "C" },
    { question: "Who enjoyed playing with friends in childhood?", id: "question4_q6", options: ["", "A", "B", "C", "D"], answer: "C" },
    { question: "Who enjoyed playing with friends in childhood?", id: "question4_q7", options: ["", "A", "B", "C", "D"], answer: "B" },
];

const correctAnswersQuestion4_2 = ['A', 'D', 'B', 'C', 'C', 'C', 'B'];
...
const question4Topic1 = {
  topic1: "Who enjoys playing with their children?",
  topic2: "Who enjoyed playing with friends in childhood?",
};
...
/* MINI_HIPPO_LESSON_DATA_START
{
  ...
  "sets": [
    ...
    {
      "id": 2,
      "title": "Who enjoyed playing with friends in childhood?",
      "data": {
        "topic": "Who enjoyed playing with friends in childhood?",
        "texts": [
          "Who enjoyed playing with friends in childhood?",
          "Who enjoyed playing with friends in childhood?",
          "Who enjoyed playing with friends in childhood?",
