...
// bộ 1
const questions1_1 = [
    { questionStart: "ádsadasd", answerOptions: ["1", "2", "3"], questionEnd: "sadasdasd", correctAnswer: "1" },
    { questionStart: "dsfsdfsdf", answerOptions: ["1", "2", "3"], questionEnd: "sdfsdfdsfsdf", correctAnswer: "1" },
];

// bộ 2
const questions1_2 = [
    { questionStart: "sadasdasdasdasd", answerOptions: ["1", "2", "3"], questionEnd: "ádasdasdas", correctAnswer: "1" },
    { questionStart: "dfsdfdsf", answerOptions: ["1", "2", "3"], questionEnd: "sdfsdfsdfsdfdsf", correctAnswer: "2" },
];

// bộ 3
const questions1_3 = [
    { questionStart: "sadasdas", answerOptions: ["2", "1", "3"], questionEnd: "đâsdsadsad", correctAnswer: "1" },
    { questionStart: "ghjghjghjgh", answerOptions: ["1", "2", "3"], questionEnd: "jghjghjghj", correctAnswer: "2" },
    { questionStart: "hfghfgh", answerOptions: ["1", "2", "3"], questionEnd: "fghfghfghfgh", correctAnswer: "2" },
];
  ...
  "sets": [
    {
      ...
      "data": {
        "questions": [
          {
            "questionStart": "ádsadasd",
            "answerOptions": [
              "1",
              "2",
              "3"
            ],
            "questionEnd": "sadasdasd",
            "correctAnswer": "1"
          },
          {
            "questionStart": "dsfsdfsdf",
            "answerOptions": [
              "1",
              "2",
              "3"
            ],
            "questionEnd": "sdfsdfdsfsdf",
            "correctAnswer": "1"
          }
        ]
      }
    },
    {
      ...
      "data": {
        "questions": [
          {
            "questionStart": "sadasdasdasdasd",
            "answerOptions": [
              "1",
              "2",
              "3"
            ],
            "questionEnd": "ádasdasdas",
            "correctAnswer": "1"
          },
          {
            "questionStart": "dfsdfdsf",
            "answerOptions": [
              "1",
              "2",
              "3"
            ],
            "questionEnd": "sdfsdfsdfsdfdsf",
            "correctAnswer": "2"
          }
        ]
      }
    },
    {
      ...
      "data": {
        "questions": [
          {
            "questionStart": "sadasdas",
            "answerOptions": [
              "2",
              "1",
              "3"
            ],
            "questionEnd": "đâsdsadsad",
            "correctAnswer": "1"
          },
          {
            "questionStart": "ghjghjghjgh",
            "answerOptions": [
              "1",
              "2",
              "3"
            ],
            "questionEnd": "jghjghjghj",
            "correctAnswer": "2"
          },
          {
            "questionStart": "hfghfgh",
            "answerOptions": [
              "1",
              "2",
              "3"
            ],
            "questionEnd": "fghfghfghfgh",
            "correctAnswer": "2"
          }
        ]
      }
